...
[`create-react-app`](https://facebook.github.io/react/blog/2016/07/22/create-apps-with-no-configuration.html) created application.

The [commit](https://github.com/mobxjs/create-react-app-mobx/commit/1702950c3483dd8901cd0a8de6c85798ddd6e0a2) that turns a freshly generated project into a MobX powered app
can be downloaded as [patch](https://github.com/mobxjs/create-react-app-mobx/blob/master/introduce-mobx.patch) and applied using
`git apply introduce-mobx.patch` (verified for apps generated by `create-react-app@0.2.0`).
Don't forget to run `npm install` afterwards. Or simple fork this repo :)

Note that this app doesn't use decorators to make the setup as simple as possible.

----
_original create-react-app readme_
...
>>>>>>> 0a371128838e003d9635c6ed416a2a601869b968
